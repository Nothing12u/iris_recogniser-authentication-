...
load = cv2.CascadeClassifier('c:/fr/haarcascade_frontalface_default.xml') #loading the cascade for face detection
...
f = open("c:/fr/datatext.txt","a") #saving user info in a file
f.write(str(id)+" "+name+"\n")
val=0
